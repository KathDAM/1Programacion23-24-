...
public class Conecta4Final {
    ...
    public static void main(String[] args) {
        ...
        Conecta4Final game = new Conecta4Final();
        char currentPlayer = PLAYER1;
    
        System.out.println("¡Bienvenido al juego Conecta 4!");
        System.out.println("¿Deseas jugar contra otro usuario (U) o contra la computadora (C)?");
    
        char choice = ' ';
        while (choice != 'U' && choice != 'C') {
            System.out.print("Ingresa tu elección: ");
            try {
                choice = Character.toUpperCase(scanner.next().charAt(0));
                if (choice != 'U' && choice != 'C') {
                    throw new InputMismatchException("Opción no válida. Debes elegir 'U' para jugar contra otro usuario o 'C' para jugar contra la computadora.");
                }
            } catch (InputMismatchException e) {
